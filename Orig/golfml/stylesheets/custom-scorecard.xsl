...
-->
	...
	<xsl:param name="country-club.name">Golf De Dieppe-Pourville</xsl:param>
	<xsl:param name="country-club.golf-course.name">Golf De Dieppe-Pourville</xsl:param>
	<xsl:param name="tee-set.name">Black (Men)</xsl:param>
